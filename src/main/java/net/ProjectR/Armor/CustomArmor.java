...
public enum CustomArmor implements ArmorMaterial {
    ...
    OAK_WOOD("oak_wood", 10, new int[]{1, 4, 5, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0F, 0.0f, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.OAK_WOOD});
    }),
    SPRUCE_WOOD("spruce_wood", 10, new int[]{1, 4, 5, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0F, 0.0f, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.SPRUCE_WOOD});
    }),
    BIRCH_WOOD("birch_wood", 10, new int[]{1, 4, 5, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0F, 0.0f, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.BIRCH_WOOD});
    }),
    JUNGLE_WOOD("jungle_wood", 10, new int[]{1, 4, 5, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0F, 0.0f, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.JUNGLE_WOOD});
    }),
    ACACIA_WOOD("acacia_wood", 10, new int[]{1, 4, 5, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0F, 0.0f, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.ACACIA_WOOD});
    }),
    ...
    CRYING_OBSIDIAN("crying_obsidian", 40, new int[]{4, 7, 9, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0F, 0.2f, () -> {
