...
public class ruinGenerator {
    ...
    public static void addParts(StructureManager manager, BlockPos pos, BlockRotation rotation, List<StructurePiece> pieces, Random random, DefaultFeatureConfig defaultConfig) {
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        public boolean generate(IWorld world, ChunkGenerator<?> generator, Random random, BlockBox box, ChunkPos pos, BlockPos pos3) {
            ...
            boolean bl = super.generate(world, generator, random, box, pos, pos3);
